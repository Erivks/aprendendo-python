...
def le_assinatura():
    print('SIMILIARIDADE ENTRE TEXTOS: ')
    print('')
    text = input("Informe o texto original: ")
    print('')
    ass_original = calcula_assinatura(text)
...
def main():
    ass_original = le_assinatura()
    textos = le_textos()
    text = avalia_textos(textos, ass_original)
    print("O texto {} é mais semelhante.".format(text))
